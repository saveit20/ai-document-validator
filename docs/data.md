...
| Stress set | 16 | 16 | ES, GB, DE, NL, FR, IT, AT, EE, CH, US | Spanish, English, French, German, Italian | EUR, GBP, USD, CHF | two-column headers, name only in the footer, totals on page 2, distractor totals, OCR-like noise, Swiss number format |

In total: 160 invoices from six sources, about 30 distinct layouts, 21 countries, 12 currencies and 6
